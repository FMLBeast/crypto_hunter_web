...
from app.services.crypto_intelligence import CryptoIntelligence
...
class EnhancedImportService(ImportService):
                    ...
                    if (use_llm and
                        ...
                        if llm_cost_used + estimated_cost <= llm_budget:
                            try:
                                ...
                                from app.services.llm_crypto_orchestrator import llm_orchestrated_analysis
    ...
    def _update_file_metadata(file: AnalysisFile, crypto_analysis: Dict[str, Any]):
        ...
        if ethereum_analysis.get('validated_keys'):
            ...
            file.node_color = '#3b82f6'  # Blue for crypto content, text) and len(text) > 50:
