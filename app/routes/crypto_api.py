...
from app.services.crypto_intelligence import CryptoIntelligence, EthereumAnalyzer, CipherAnalyzer
...
def crack_hash():
    ...
    from app.services.crypto_intelligence import AdvancedCryptoAnalyzer
