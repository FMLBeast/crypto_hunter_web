...
class ExtractionService:
    ...
    def extract_from_file(file_id: int, extraction_method: str, parameters: Dict = None, 
                         user_id: int = None, async_mode: bool = True, use_llm: bool = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if async_mode:
                ...
                task = extract_from_file.delay(file_id, extraction_method, parameters, user_id, use_llm)
                ...
                # Run synchronously
                return extract_from_file(file_id, extraction_method, parameters, user_id, use_llm)
    ...
    @staticmethod
    def extract_all_methods(file_id: int, user_id: int = None, async_mode: bool = True, use_llm: bool = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if async_mode:
                # Run in background using Celery
                task = extract_all_methods.delay(file_id, user_id, use_llm)
                ...
                # Run synchronously
                return extract_all_methods(file_id, user_id, use_llm)
    ...
    def extract_to_production(file_id: int, output_dir: str = "production", 
        ...
        try:
            ...
            if async_mode:
                # Run in background using Celery
                task = extract_to_production.delay(file_id, output_dir, user_id, use_llm)
                ...
                # Run synchronously
                return extract_to_production(file_id, output_dir, user_id, use_llm)
